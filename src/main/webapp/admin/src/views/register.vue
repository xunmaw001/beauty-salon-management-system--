<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">基于微信小程序的美容院管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.dianhuahaoma" class="input" type="text" placeholder="电话号码">
			   </div>
			 </div> -->
			<el-form-item label="电话号码" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.dianhuahaoma" autocomplete="off" placeholder="电话号码"  />
			</el-form-item>
 ...
 //  }
	...
	.container {
		...
		background-repeat: no-repeat;
    				background-image: url(http://codegen.caihongy.cn/20201206/50c807ac1b214e388d1202abfd5d4c83.jpg);
      ...
      box-sizing: border-box;
			...
			border-color: rgba(124, 105, 168, 1);
        ...
        .send-code {
          ...
          line-height:40px;
					...
					border-width: 1px;
					border-style: solid;
					border-color: rgba(37, 70, 190, 1);
					border-radius: 10px;
					background-color: rgba(62, 52, 84, 1);
          box-shadow: 0 0 6px rgba(255,0,0,0);
				}

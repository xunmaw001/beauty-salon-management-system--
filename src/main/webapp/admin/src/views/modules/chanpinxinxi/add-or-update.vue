  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chanpinbianhao" label="产品编号" prop="chanpinbianhao">
              <el-input v-model="ruleForm.chanpinbianhao" 
                placeholder="产品编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="产品分类" prop="chanpinfenlei">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.chanpinxiangqing = this.ruleForm.chanpinxiangqing.replace(reg,'../../../ssm61564/upload');
        } else {
          this.$message.error(data.msg);
        }
      });

<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <div v-if="type=='info'">
          <el-form-item class="input" label="下单时间" prop="addtime">
          ...
          <el-row>
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.logistics" label="物流" prop="logistics">
                    <span v-html="ruleForm.logistics"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.logistics = this.ruleForm.logistics.replace(reg,'../../../ssm61564/upload');
        } else {

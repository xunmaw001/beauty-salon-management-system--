	...
	export default {
		data() {
			return {
				...
				ruleForm: {},
				user: {},
				heads: {"headLogoutFontHoverColor":"rgba(174, 174, 174, 1)","headFontSize":"20px","headUserInfoFontColor":"rgba(0, 0, 0, 1)","headBoxShadow":"0 1px 6px #444","headTitleImgHeight":"44px","headLogoutFontHoverBgColor":"rgba(255, 255, 255, 0.63)","headFontColor":"rgba(255, 255, 255, 1)","headTitleImg":false,"headHeight":"60px","headTitleImgBorderRadius":"22px","headTitleImgUrl":"http://codegen.caihongy.cn/20201021/cc7d45d9c8164b58b18351764eba9be1.jpg","headBgColor":"radial-gradient(circle, rgba(68,85,171,1) 0%, rgba(226,122,143,0.8365721288515406) 100%)","headTitleImgBoxShadow":"0 1px 6px #444","headLogoutFontColor":"rgba(94, 92, 92, 1)","headUserInfoFontSize":"16px","headTitleImgWidth":"44px","headTitleStyle":"2","headLogoutFontSize":"16px"},
			};
		},
		created() {
			this.setHeaderStyle()

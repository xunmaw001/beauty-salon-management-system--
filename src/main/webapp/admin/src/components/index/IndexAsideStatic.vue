      ...
      this.$nextTick(()=>{
        document.querySelectorAll('.menulist .el-menu-item').forEach(el=>{
          el.addEventListener("mouseenter", e => {
            e.stopPropagation()
            el.style.backgroundColor = "rgba(205, 205, 205, 0.2)"
          })
  ...
  .index-aside {
    ...
    .menulistImg {
      ...
      .el-image {
		...
		background: radial-gradient(circle, rgba(68,85,171,1) 0%, rgba(226,122,143,0.8365721288515406) 100%) !important;
		...
		& /deep/ .el-menu.el-menu--inline {
			...
			.el-menu-item {
                ...
                &.is-active {
                    ...
                    background-color: rgba(221, 141, 163, 1) !important;
                    box-shadow: 0 0 6px rgba(30, 144, 255, 0);
                    text-align: center;
                }
